...
@section('content')
    ...
    <div class="page-header">
        ...
        @if ($giPermissoes->permite($recurso.'.criar'))
                        ...
                        <tr class="{{ $registro->trashed() ? 'table-light text-muted' : '' }}">
                            ...
                            <td class="text-center text-nowrap">
                                <div class="d-inline-flex gap-1">
                                    @if ($registro->trashed())
                                        @if ($giPermissoes->permite($recurso.'.restaurar'))
                                        ...
                                        @endif
                                        @if ($giPermissoes->permite($recurso.'.excluir_definitivamente'))
                                        ...
                                        @endif
                                    @else
                                        @if ($giPermissoes->permite($recurso.'.visualizar'))
                                        ...
                                        @endif
                                        @if ($giPermissoes->permite($recurso.'.editar'))
                                        ...
                                        @endif
                                        @if ($giPermissoes->permite($recurso.'.excluir'))
