    ...
    <div class="card content-card">
        ...
        <div class="card-body">
            ...
            <div class="d-flex justify-content-end gap-2 mt-4">
                @if ($giPermissoes->permite($recurso.'.editar'))<a href="{{ route($recurso.'.edit', $registro) }}" class="btn btn-primary"><i class="bi bi-pencil-fill me-1"></i>Editar</a>@endif
                @if ($giPermissoes->permite($recurso.'.listar'))<a href="{{ route($recurso.'.index') }}" class="btn btn-outline-secondary"><i class="bi bi-arrow-left me-1"></i>Voltar</a>@endif
            </div>
        </div>
    </div>
@endsection
